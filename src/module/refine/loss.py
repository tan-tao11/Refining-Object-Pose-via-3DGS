...
class RefineLoss(nn.Module):
    ...
    def forward(self, data):
        ...
        # GT rotation residual in LOCAL frame:
        # R_gt = R_init @ delta_R_gt  =>  delta_R_gt = R_init^T @ R_gt
        # Since R_init = R_gt @ R_noise, delta_R_gt = R_noise^T (always near identity)
        delta_R_gt = R_init.transpose(-1, -2) @ R_gt
